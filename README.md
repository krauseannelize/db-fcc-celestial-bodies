...
This is one of the required projects to earn the [freeCodeCamp Relational Database certification](https://www.freecodecamp.org/learn/relational-database/). For the [Celestial Bodies Database project](https://www.freecodecamp.org/learn/relational-database/build-a-celestial-bodies-database-project/build-a-celestial-bodies-database), I will build a database of celestial bodies using PostgreSQL within a virtual Linux environment powered by Gitpod.
